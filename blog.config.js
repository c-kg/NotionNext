...
const BLOG = {
  ...
  AUTHOR:'cuber_kg', // 您的昵称 例如 tangly1024
  BIO: 'terry main', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cuberkg.eu.org', // 网站地址
  ...
  // 动态彩带特效
  FLUTTERINGRIBBON: process.env.NEXT_PUBLIC_FLUTTERINGRIBBON || ftrue, // 开关
  // 静态彩带特效
